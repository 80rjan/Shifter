//package com.shifterwebapp.shifter.learning.domain.service;
//
...
//import com.shifterwebapp.shifter.shared.exception.AlreadyEnrolledException;
...
//
//        List<CourseLecture> courseLectures = courseVersion.getCourseModules().stream()
//                .flatMap(content -> content.getCourseLectures().stream())
//                .toList();
//
//        List<LectureProgress> progressList = courseLectures.stream()
//                .map(lecture -> LectureProgress.builder()
...
//                .toList();
//
//        lectureProgressRepository.saveAll(progressList);
//
//        CourseTranslation courseTranslate = course.getTranslations()
//                .stream()
...
//
//        boolean allCompleted = lectureProgresses.stream().allMatch(LectureProgress::isCompleted);
//
//        Enrollment enrollment = enrollmentRepository.findById(enrollmentId).orElseThrow();
//
