...
function Mentoring() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        Position in the business: ${user?.workPosition || "Not provided"}
                ...
                <div
                    ...
                    <div className="flex flex-col gap-6 flex-1
                        ...
                        <div className="flex flex-col gap-3
                            ...
                            <p className="font-light text-black-text/60 text-sm leading-relaxed
                                sm:text-md sm:whitespace-nowrap sm:col-span-2
                                md:text-base
                                2xl:text-lg">
                                {t("workPosition")}: <span className="text-black-text font-normal">{user?.workPosition}</span>
                            </p>
                        </div>
